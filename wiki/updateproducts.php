    ...
    <section class="wiki">
        <div class="center">
            <div class="wiki-container">
                ...
                <p class="wiki-p">
                    Once you have logged in as an admin. You can navigate to this url: <a class="wiki-links" href="admin/index.php">https://https://wheelspire.liamhilbers.dev/wiki/manageaccount.phpadmin/index.php</a>.
                </p>
                <br>
